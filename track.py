...
def getTemplate(img, i, key):
	...
	if key.upper() == 'BOLT':
		bbox = [[75,269,139,303], [76, 225, 165, 259],  [80, 331, 144, 365]] # bolt
	elif key.upper() == 'CAR':
	...
	template = gray[bbox[i][0]:bbox[i][2],bbox[i][1]:bbox[i][3]]
...
def track_car(input_path, output_path):
	...
	for im in images[0:]:
		...
		Pn = kidharGayaBe_car(HGIM,G,box,P)
		P = Pn
...
def track_bolt(input_path, output_path):
	...
	fname.append(input_path + '/0190.jpg')
	gray_temp = []
	img = []
	G = []
	box = []
